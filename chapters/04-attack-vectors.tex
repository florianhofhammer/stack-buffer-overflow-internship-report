		...
		\begin{tabular}{|l|*{6}{P{\colwidth}|}}
			...
			\textbf{Attack approach}		& \multicolumn{6}{@{}l@{}}{
								\begin{tabular}{*{6}{p{\colwidth}|}}
									...
									\texttt{\_FORTIFY\linebreak[0]\_SOURCE}	& \raggedright \acs{dep} / \acs{nx} bit	& \raggedright \acs{aslr} (without \acs{pie} / \acs{pic})	& \acs{aslr} (with \acs{pie} / \acs{pic})	& Stack canaries	& (full) \acs{relro}	\\
								\end{tabular}					
							  } \\ \hline
			Code injection:					&		 &		  &		   &		&		 &		  \\

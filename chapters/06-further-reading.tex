...
Thirdly, the choice of compiler can make a difference in the emitted assembly code and thus also the assembled byte code and functionality.
...
In this paper, focus is lying on overflows of stack buffers.
